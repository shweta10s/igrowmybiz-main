            ...
            <div className='py-4 border-mainColor border-y-4 sm:h-28 h-24 mt-10'>
                <div className='overflow-hidden relative h-full w-[90%] xl:w-4/5 mx-auto my-auto'>
                    ...
                    <div className='relative grow-0 shrink-0 w-12 h-12 sm:w-16 sm:h-16'>
                            <Image src={'/assets/images/nodejs.svg'} alt='bbb' fill className='filter grayscale hover:grayscale-0 object-contain scale-[1.5]' />
                        </div>
            
                        <div className='relative grow-0 shrink-0 w-12 h-12 sm:w-16 sm:h-16'>
                            <Image src={'/assets/images/t3-stack.svg'} alt='bbb' fill className='filter grayscale hover:grayscale-0 object-contain' />
                        </div>
                        ...
                        <div className='relative grow-0 shrink-0 w-12 h-12 sm:w-16 sm:h-16'>
                            <Image src={'/assets/images/expressjs_logo.webp'} alt='bbb' fill className='filter grayscale hover:grayscale-0 object-contain scale-[1.5]' />
                        </div>
