...
export default function DevelopmentSectionOne() {
    return (
        <section className='relative h-[70vh] md:h-[85vh] w-full hero'>
            ...
            <div className='w-full h-full flex justify-center items-center flex-col gap-10 bg-black'>
                <div className='lg:w-3/4 xl:w-1/2 md:w-2/3 flex flex-col gap-4 relative mt-14'>
                    ...
                    <h1 className='text-white flex flex-col items-center justify-center text-3xl lg:text-7xl sm:text-5xl gap-1 lg:gap-4 font-bold text-center'>To Maximizing <span>Your ROI</span></h1>
